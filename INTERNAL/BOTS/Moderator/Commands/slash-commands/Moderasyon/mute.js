...
module.exports = class MuteCommand extends SlashCommand {
    ...
    async run(ctx) {
        ...
        const mPerms = new Discord.MessageEmbed().setColor('#2f3136').setDescription(`Bunu yapmak için yeterli yetkiye sahip değilsin`);
        ...
        const bPerms = new Discord.MessageEmbed().setColor('#2f3136').setDescription(` Bu kişiyi banlamak için yeterli yetkiye sahip değilim`)
